...
#BOOST_INCLUDE_PATH=src/boost_1_57_0
#BOOST_LIB_PATH=src/boost_1_57_0/stage/lib
...
LIBPNG_INCLUDE_PATH=src/libpng-1.6.16
LIBPNG_LIB_PATH=src/libpng-1.6.16/.libs
QRENCODE_INCLUDE_PATH=src/qrencode-3.4.4
QRENCODE_LIB_PATH=src/qrencode-3.4.4/.libs
SECP256K1_LIB_PATH = src/secp256k1/.libs
SECP256K1_INCLUDE_PATH = src/secp256k1/include
#SECP256K1_INCLUDE_PATH = src/secp256k1
}
...
macx:ICON = src/qt/res/icons/Versuscoin.icns
macx:TARGET = "Versuscoin-Qt"
